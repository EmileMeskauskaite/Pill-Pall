...
router.put("/user/:userId/password", tokenVerification.verifyUser, UsersController.updatePassword);
router.put("/caretaker/:caretakerId",tokenVerification.verifyCaretaker, UsersController.updateCaretaker);
router.put("/caretaker/:caretakerId/password", tokenVerification.verifyCaretaker, UsersController.updatePassword);
